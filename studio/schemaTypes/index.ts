...
export const schemaTypes = [
  ...
  components.homepageH1Component,
  components.homepageHeroLink,
  components.homepageHeroComponent,
  components.homepageEventCardsComponent,
  ...
  components.homepagePageBuilder,
  ...
  components.articleScrollContainer,
];
